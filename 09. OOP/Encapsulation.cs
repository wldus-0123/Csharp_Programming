...
namespace _09._OOP
{
    internal class Encapsulation
    {
        ...
        class Capsule
        {
            ...
            void Function() { } //  멤버함수(메소드) : 객체의 기능을 표현
        }

        // < 접근제한자 >
        // 외부에서 접근이 가능한 멤버변수와 멤버함수를 지정하는 기능
        // 접근제한자를 지정하지 않는 경우 기본 접근제한자는 private (비공개)
        // public    : 외부에서도 접근가능
        // private   : 내부에서만 접근가능 (사용된 블럭 내부에서만)
        // protected : 상속한 클래스에서 public, 그외에는 private
        // internal  : 같은 어셈블리 내에서 public, 그외에는 private -- 쓰지말라함
        ...
        class Bank
        {
            int balance; //private이 기본 - 외부에서 접근 불가능
